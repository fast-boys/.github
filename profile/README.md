...
| `DevOps`<br>[@404](https://github.com/404-not-foundl)<br>[Infra]<br>[Authentication Server]<br>[Stream Server] |   `Back Dev.`<br>[@JaeMin Lee](https://github.com/Chosamee)<br>[Core Server](https://github.com/fast-boys/core)    | `AI Dev.`<br>[@Lee](https://github.com/Lee-search)<br>[AI Server]<br>[Search Server] |
